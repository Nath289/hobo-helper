// ==UserScript==
// @name         HoboWars Drinks Helper
// @namespace    http://tampermonkey.net/
// @version      0.8
// @description  Purely informational: shows the limiting ingredient on a new line.
// @author       Gemini
...
(function() {
    ...
    function handleBartenderGuide() {
        // Specifically targeting table rows that contain the mixer 'make' links
        ...
        mixerLinks.forEach(link => {
            try {
                ...
                // Mark as processed early to prevent infinite loops
                ...
                // First image is the result, subsequent are ingredients
                ...
                limiterDiv.style.display = 'block'; // Ensures new line
                ...
                console.error("HoboWars Helper Error:", err);
            }
        });
    }

    // Debounced observer to handle AJAX page loads without hitting recursion errors
    let timeout = null;
